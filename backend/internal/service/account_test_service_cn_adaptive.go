...
// DeepSeek、Kimi 与 MiniMax additionally use their native Responses endpoints.
...
func (s *AccountTestService) testCNProviderAdaptiveResponsesConnection(c *gin.Context, account *Account, testModelID string, authToken string) error {
	...
	// DeepSeek / Kimi / MiniMax native Responses endpoints are stateless and do not need
