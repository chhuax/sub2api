export default {
    settings: {
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: '当账号当前原生用量窗口（OpenAI Codex、Anthropic 会话、Grok 利用率或 Coding Plan 配额）达到该百分比时，Sub2API 会临时将其移出调度，直到窗口重置。填 100 表示禁用。',
        ...
        accountSchedulingThresholdsRangeHint: '整数 1–100（百分比）。'
      },
